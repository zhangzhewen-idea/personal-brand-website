...
export const videos: VideoItem[] = [
  { id: 1, ...audit, videoTitle: '为什么这部电影能封神', videoIntro: '从叙事结构、镜头语言和人物动机三个角度拆解。', videoUrl: 'https://cdn.example.com/videos/video-1.mp4', videoCover: 'https://images.unsplash.com/photo-1709316131422-35a5fb1e9eb2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080', platformName: '抖音', playCountText: '180万' },
  { id: 2, ...audit, videoTitle: '三分钟看懂角色弧光', videoIntro: '用一个完整案例讲清角色变化如何服务主题表达。', videoUrl: 'https://cdn.example.com/videos/video-2.mp4', videoCover: 'https://images.unsplash.com/photo-1723396612574-961649793bb9?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080', platformName: 'B站', playCountText: '95万' },
  { id: 3, ...audit, videoTitle: '我最常用的剪辑节奏模板', videoIntro: '分享节奏控制、转场和音效搭配的常用方法。', videoUrl: 'https://cdn.example.com/videos/video-3.mp4', videoCover: 'https://images.unsplash.com/photo-1695408246958-5e557ba72ab5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080', platformName: '小红书', playCountText: '62万' },
  { id: 4, ...audit, videoTitle: '城市脉搏：延时摄影混剪', videoIntro: '捕捉城市的昼夜更替，感受时间的流动之美。', videoUrl: 'https://cdn.example.com/videos/video-4.mp4', videoCover: 'https://images.unsplash.com/photo-1693159682618-074078ed271e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080', platformName: '抖音', playCountText: '210万' },
]
...
export const matrixAccounts: MatrixAccount[] = [
  { id: 1, ...audit, platformName: '抖音', platformLogo: 'https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=100&h=100&fit=crop', accountUrl: 'https://www.douyin.com/user/example', intro: '主阵地账号，更新电影解说和剪辑技巧内容。', followerCountText: '15万', colorClass: 'bg-black' },
  { id: 2, ...audit, platformName: 'B站', platformLogo: 'https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=100&h=100&fit=crop', accountUrl: 'https://space.bilibili.com/example', intro: '偏长内容与系列化专题，适合深度解析。', followerCountText: '8万', colorClass: 'bg-pink-500' },
  { id: 3, ...audit, platformName: '小红书', platformLogo: 'https://images.unsplash.com/photo-1611162618071-b39a2ec055fb?w=100&h=100&fit=crop', accountUrl: 'https://www.xiaohongshu.com/user/profile/example', intro: '偏图文和短视频种草，展示幕后和素材整理。', followerCountText: '5万', colorClass: 'bg-red-500' },
  { id: 4, ...audit, platformName: '视频号', platformLogo: 'https://images.unsplash.com/photo-1611162616475-46b635cb6868?w=100&h=100&fit=crop', accountUrl: 'https://weixin.qq.com', intro: '同步发布精选内容。', followerCountText: '3万', colorClass: 'bg-green-500' },
]
